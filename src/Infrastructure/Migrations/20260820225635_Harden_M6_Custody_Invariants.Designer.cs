...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260820225635_Harden_M6_Custody_Invariants")]
    partial class Harden_M6_Custody_Invariants
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("custodies", "public", t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_custodies_state_time_valid", "(status = 'Active' AND to_utc IS NULL AND return_document_id IS NULL) OR (status = 'Closed' AND to_utc IS NOT NULL AND from_utc < to_utc)");
