...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260808165612_Add_DocumentSpineAndImmutableLedger")]
    partial class Add_DocumentSpineAndImmutableLedger
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.StockMovements.StockMovement", b =>
                {
                    ...
                    b.HasIndex("LineId")
                        .HasDatabaseName("ix_stock_movements_line_id");
            ...
            modelBuilder.Entity("Domain.StockMovements.StockMovement", b =>
                {
                    ...
                    b.HasOne("Domain.DocumentLines.DocumentLine", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_stock_movements_document_lines_line_id");
